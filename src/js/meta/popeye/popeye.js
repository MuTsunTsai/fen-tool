...
function createParseContext(input, initFEN, output) {
...
/** Reset stack */
function parseReset(context, text) {
...
/** Enter twin */
function parseTwin(context, text) {
 ...
 */
export function inferMoveOrdering(stip, halfDuplex = false) {
