...
- You can also generate a URL that represents the image using `Create image URL` button.\
  Note: This service currently is provided by [https://thumbsnap.com/](https://thumbsnap.com/),
  and the image URL generated by it could open a standalone webpage when access through the address bar of a browser,
  but when embedded elsewhere it behaves totally normal.
